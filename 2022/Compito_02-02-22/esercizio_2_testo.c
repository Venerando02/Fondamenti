...
int carica_percorsi(/* lo studente inserisca i parametri formali richiesti */) {
	FILE* f = NULL;
...
double calcolo_lunghezza_percorso(/* lo studente inserisca i parametri formali richiesti */) {
...
double* calcola_lunghezza_percorsi(/* lo studente inserisca i parametri formali richiesti */) {
...
int calcola_percorso_massimo(/* lo studente inserisca i parametri formali richiesti */) {
