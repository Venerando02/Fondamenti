...
delle frasi
3. Funzione che restituisce la lunghezza (numero di parole) della frase più breve e della frase più lunga
*/
...
//quesito2: restituire la lunghezza (numero di parole) della frase più breve e della frase più lunga
