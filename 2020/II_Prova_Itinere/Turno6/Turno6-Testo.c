...
storico degli acquisti dei clienti di un supermercato (transazioni). 
L'archivio è un file di testo in cui ogni riga riporta,
separati da spazio, le seguenti informazioni: 
codice cliente, data, importo della spesa, saldo punti. 
Ogni 10 euro di spesa, il cliente guadagna 1 punto fedeltà. 
Il cliente, a fronte di una spesa minima di
50 euro utilizzarà 50 punti fedeltà per ricevere uno sconto di 5 euro
sul totale della spesa. 
Il saldo punti verrà aggiornato in base all'importo effettivamente pagato. 
E' possibile utilizzare al più 50 punti per transazione.
...
1. CaricaStorico: carica lo storico da file in una lista di transazioni.
